...
public class LoopIndicator extends View {
    ...
    public LoopIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ovalRadius = typedArray.getDimensionPixelSize(R.styleable.LoopIndicator_ovalradius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources().getDisplayMetrics()));
        ...
        ovalDivither = typedArray.getDimensionPixelSize(R.styleable.LoopIndicator_ovaldivther, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, getResources().getDisplayMetrics()));
        typedArray.recycle();
        paint = new Paint();
